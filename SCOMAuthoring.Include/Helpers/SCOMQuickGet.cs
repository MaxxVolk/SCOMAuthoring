...
namespace SCOMAuthoringBook.Library.Helpers
{
  public static class SCOMQuickGet
  {
    ...
    /// <summary>
    /// Converts descriptive Management Pack element reference or class instance reference to SCOM Guid using SHA1 hash. (c) Microsoft.
    /// </summary>
    /// <param name="textToHash">Management Pack element reference or class instance reference.</param>
    /// <returns>SCOM Id (Guis/uniqueidentifier)</returns>
